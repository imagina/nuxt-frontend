...
const rentParams = router.currentRoute.value.query

const {data} = useAsyncData('irentCar::rent-gammas', () =>
  irentcarReservationRepository.availableGammas({
    include: 'files',
    filter: {
      'pickup_office_id': rentParams.pickupOfficeId,
      'pickup_date': `${rentParams.pickupDate} ${rentParams.pickupTime}:00`,
      'dropoff_office_id': rentParams.dropOfficeId,
      'dropoff_date': `${rentParams.dropDate} ${rentParams.dropTime}:00`,
    }
  })
)
...
const trip = reactive({
  details: {
    ...
    dates: [
      {label: 'Fecha y hora de la recogida', text: `${rentParams.pickupDate} ${rentParams.pickupTime}:00`},
      {label: 'Fecha y hora de devolución', text: `${rentParams.dropDate} ${rentParams.dropTime}:00`}
    ]
  },
  contact: [
      ...
      <template #rates>
        ...
        <div class="grid gap-10 grid-cols-1 lg:grid-cols-3 mt-6">
          ...
          <div class="col-span-12 lg:col-span-2 main-stepper">
              ...
              <div class="grid grid-cols-12 gap-4 items-end">
                ...
                <div class="col-span-6 md:col-span-4 lg:col-span-5">
                  <UFormField label="Transmisión" :ui="formUI">
                    <USelect size="md" v-model="filter.transmision" :items="transmisiones" placeholder="Todos"
                             class="w-full"/>
                  </UFormField>
                </div>
                <div class="col-span-12 md:col-span-3 lg:col-span-2">
                  <UButton size="md" variant="soft" @click="resetFilters" class="w-full justify-center bg-gray-4">
                    Restablecer
                  </UButton>
                </div>
              </div>
            ...
            <!-- Listado -->
            <div v-for="car in availableGammas" :key="car.id" class="transition mt-8 rounded-sm">
              <div class="grid grid-cols-12 justify-between gap-4">
                <!-- Texto -->
                <div class="col-span-8 md:col-span-6 ">

                  <!--                  <UBadge :ui="badgeUI" v-if="car.recommended" color="primary" variant="soft" size="xs">-->
                  <!--                    Recomendado para ti-->
                  <!--                  </UBadge>-->

                  <h4 class="stepper-title"> {{ car.description }} </h4>
                  <div class="text-[16px] text-secondary uppercase mb-2 font-normal">{{ car.title }}</div>
                ...
                <!-- Imagen TODO: agregar Files -->
                <div class="col-span-4 md:col-span-2 ">
                  <IMediaRender
                    :media="{isImage: true, url: '/images/kia-automatico.jpg'}" :alt="car.title"
...
<!--                      <Icon class="h-4 w-4 mr-1" name="material-symbols:check-small"/>-->
<!--                      {{ f }}-->
<!--                    </div>-->
<!--                  </details>-->
          ...
          <div class="col-span-12 lg:col-span-2 main-stepper">
            ...
            <div class="botons-up flex gap-2 justify-between mt-4 mb-5">
              <UButton leading-icon="i-lucide-arrow-left" @click="prev"
                       class="bg-white text-primary hover:bg-white hover:text-secondary">Atrás
              </UButton>
              <UButton trailing-icon="i-lucide-arrow-right" @click="next"
                       class="bg-white text-primary hover:bg-white hover:text-secondary">Continuar
              </UButton>
            </div>
            ...
            <div class="main-resume info-card" v-if="selectedCar">
              <div class="grid grid-cols-12 justify-between gap-x-4">
                ...
                <div class="col-span-12 mb-3">
                  ...
                  <h4 class="stepper-title inline-block"> {{ selectedCar.description }} </h4>
                  <span class="text-gray-3 mx-2 text-[20px] ">|</span>
                  <div class="text-[20px] text-secondary uppercase mb-2 font-normal inline-block">{{
                      selectedCar.title
                    }}
                  </div>
                ...
                <div class="col-span-3 ">
                  <IMediaRender
                    :media="{isImage: true, url: '/images/kia-automatico.jpg'}" :alt="selectedCar.title"
                    aspect-ratio="aspect-[1/1]"
                    :ui="{
                        wrapper: '',
                        container: '',
                ...
                <div class="col-span-9 ">
                  ...
                  <div class="stepper-summary mb-2">
                    Mejore la selección de su vehículo con un “Referencia de carro” o similar por solo $0.000 COP
                    diarios y pague un precio total de $000.000 COP
                  </div>

                  <div class="flex items-center gap-3 text-[13px] text-gray-3 mb-2">
                    <div class="flex items-center gap-1">
                      <Icon size="lg" name="mdi:car-shift-pattern"/>
                      {{ selectedCar.transmissionType.title }}
                    </div>
                    <div class="flex items-center gap-1">
                      <Icon size="lg" name="material-symbols:person"/>
                      {{ selectedCar.passengersNumber }}
                    </div>
                    <div class="flex items-center gap-1">
                      <Icon size="lg" name="mdi:briefcase"/>
                      {{ selectedCar.luggage }}
...
<!--                    </div>-->
            ...
            <div class="main-resume ">
              ...
              <div class="item">
                ...
                <details class="group inline px-0">
                  <summary
                    class="inline-flex text-[14px] items-center gap-1 text-blue-600 cursor-pointer hover:underline mb-3">
                    <Icon name="tabler:caret-down-filled" class="h-4 w-4 transition-transform group-open:rotate-270"/>
                    Detalles
                  </summary>
                  <div class="pl-3 pb-3">
              ...
              <div class="side-resume card-mini" v-if="selectedCar">
                <div class="grid grid-cols-12 gap-x-4">
                  ...
                  <div class="col-span-7">
                    ...
                    <h4 class="stepper-subtitle"> {{ selectedCar.description }} </h4>
                    <div class="text-[16px] mb-2">{{ selectedCar.title }}</div>
                    <div class="text-[13px] text-gray-3 mb-2">
                      <div class="flex items-center gap-1">
                        <Icon size="lg" name="material-symbols:person"/>
                        {{ selectedCar.passengersNumber }} Pasajeros
                      </div>
                      <div class="flex items-center gap-1">
                        <Icon size="lg" name="mdi:briefcase"/>
                        {{ selectedCar.luggage }} maletas
                      </div>
                    </div>
      ...
      <template #review>
        <div class="grid gap-10 grid-cols-1 lg:grid-cols-3 mt-6">
          ...
          <div class="col-span-12 lg:col-span-2 main-stepper">
            ...
            <div class="stepper-summary text-gray-3">El precio COP que se muestra se convierte de la moneda de su
