...
import {STEPS, RENT_CTX, INITIAL_RESERVATION_DATA, STEPS_POSITIONS} from './config'
import type {ReservationData, RentCtx, StepKey} from './stepperPage'
...
const ctx: RentCtx = {
  step, gammaOffices,
  reservationPreview,
  editStep, next, prev, completeReservation
}
      ...
      <div v-else id="stepperMain">
        ...
        <div v-if="stepComponent" class="mt-6 flex flex-col lg:flex-row lg:flex-wrap gap-10">
          ...
          <div class="w-full lg:flex-[0_0_calc(33.333%-1.25rem)] side-stepper">
            ...
            <Resume v-else :reservation="reservationPreview" can-edit @edit="editStep"/>
          </div>
        </div>
      </div>
    </div>
